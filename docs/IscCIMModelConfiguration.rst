...
.. list-table:: **IscCIMModelConfiguration Field Values**
   :widths: 2 5 15
   ...
   * - Integer
     ...
     - The CIM model type enum.
        ...
        - 1 - FullModel
        - 2 - DifferenceModel (currently unsupported in IPSA)
   ...
   * - List[Integer]
     - ProfileSet
     - The profiles used in this model. For import, this is the list of profiles that will be read; for export, this is the list of profiles that will be made from the IPSA model. The profiles are indicated by enums and the mappings are as follows:
