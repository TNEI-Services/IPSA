...
PyIPSA 3.2.0 uses Python 3.11 and we only offer a 64 bit application as of 2023. Note that since Python developed Python 3.9, embedded C applications have to be constructed for Python with the version that is required for users. 
Therefore if you use an alternative version of Python 3, the PyIPSA 3.2.0 installation will not work. 
