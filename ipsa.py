...
# Fixing gaps in documentation EL 11/2023
    ...
    def AddDiagram(self, network,
        ...
        :param nSceneMeasurementUnit: The unit used for the geographic scale.
            ...
            * 7 if Miles
        :type nSceneMeasurementUnit: int
        :return: The diagram UID for the newly created diagram.
        :rtype: int
        """
        pass
    ...
    def AddDiagram(self, network,
        ...
        :type nCopyWhat: int
        :param nDiagramToCopy: The UID of the diagram that any components may be copied from.
        :type nDiagramToCopy: int
        :return: The diagram UID for the newly created diagram.
        :rtype: int
        """
        pass
    ...
    def AddSLDiagram(self, network, strSceneTitle: str) -> int:
        """
        Creates a new single line diagram for the identified network.
        Returns the diagram UID corresponding to the new diagram.
        Note that this function causes IPSA to rebuild the IscDiagram data maps.
    ...
    @overload
    def DeleteDiagram(self, network, pDiagram: IscDiagram)-> bool:
        """
        ...
        :return: True if the diagram is deleted.
        :rtype: bool
        """
        pass

    @overload
    def DeleteDiagram(self, network, nUID: int) -> bool:
        """
    ...
    @overload
    def DeleteDiagram(self, network, strName: str) -> bool:
        """
    ...
    def CloseDiagram(self, nUID: int) -> bool:
        """
        Closes (in the UI) the diagram identified by ID nUID in the current network.

        :param nUID: The diagram ID to be closed.
        :type nUID: int
        :return: True if the diagram is closed.
        :rtype: bool
        """
        pass
    ...
    def GetOptimiseSaveFileSize(self) -> int:
        """
    ...
    def SetOptimiseSaveFileSize(self, nSaveFileType: int):
        """
...
class IscNetwork:
    ...
    def AddSLDiagram(self, strSceneTitle: str) -> int:
        """
        Creates a new single line diagram for the network.
        Returns the diagram UID corresponding to the new diagram.
        Note that this function causes IPSA to rebuild the IscDiagram data maps.
        This is equivalent to calling AddDiagram with bIsDiagramSingleLine = True.
    ...
    @overload
    def DeleteDiagram(self, pDiagram: IscDiagram)-> bool:
        """
    ...
    @overload
    def DeleteDiagram(self, nUID: int) -> bool:
        """
    ...
    @overload
    def DeleteDiagram(self, strName: str) -> bool:
        """
    ...
    def GetLFSummaryResults(self) -> bool:
        ...
        Call this function to prepare the summary of load flow results. If a load flow has been run since the last call, this must be called again to update the summary to the most recent results. The summary results contain:
            ...
            - Total active and reactive power of all loads
            - Total active and reactive power of all induction machines
            - Total active and reactive power of all universal machines
            - Total active and reactive power on all slack busbars
        
        :return: True if load flow results exist, False if no load flow results are available.
        :rtype: bool
        """
        pass
